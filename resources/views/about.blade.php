...
<body class="h-full">
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            ...
            <h2 class="text-muted">Learn more about who we are and what we do.
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('img/A3.png') }}" alt="Our Story" class="img-fluid rounded" style="border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 150px;">
                    </div>
                </div>
                </div>
                    <div class="col-md-6">
                ...
                <div class="display: center;">
                    <div class="col-md-6">
                        <img src="{{ asset('img/A1.png') }}" alt="Our Team" class="img-fluid rounded" style="border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 150px;">
                </div>
            </h2>
